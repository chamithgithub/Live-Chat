...
public class Controller {
    ...
    public AnchorPane logCon;
    public AnchorPane SignUpCon;
    ...
    public void changeWindow() {
        try {
            ...
            Parent root = FXMLLoader.load(this.getClass().getResource("../view/Room.fxml"));
            stage.setScene(new Scene(root, 388, 561));
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        Stage window = (Stage) logCon.getScene().getWindow();
    ...
    public void LogInHereAction(ActionEvent actionEvent) throws IOException {
        Stage window = (Stage) SignUpCon.getScene().getWindow();
